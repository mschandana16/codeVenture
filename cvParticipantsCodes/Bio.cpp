// This is the code for level 0 of the hunt
#include <iostream> 
#include <string>
#include <ctime>
#include <sstream>
...
int main() {
    // string s=""; //Initialize this string with the clue found via insta story no.0 .
    //  Ensure that there are no extra delimiters or spaces. 
